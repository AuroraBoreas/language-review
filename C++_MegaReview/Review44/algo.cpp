...
{
    /// make heap pop
    std::vector<int> v{2,1,3,99,99,99,0,-1,99,0};
...
void TS::algo_query_value(void)
{
    ...
    std::vector<int> u{2,1,3,99,99,99,0,-1,99,0};
