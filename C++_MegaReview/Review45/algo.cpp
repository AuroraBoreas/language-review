...
void TS::algo_set(void)
{
    ...
    TS::print("std::symmetric_difference, S-> ", S);
}
...
void TS::algo_query_property(void)
{
    ...
    std::string m{"hello ZL"};
    std::string n("halo TS");
...
void TS::algo_lone_island(void)
{
    ...
    std::string m{"Pariatur nulla sit ullamco mollit qui voluptate proident anim elit nostrud."};
    std::string n;
